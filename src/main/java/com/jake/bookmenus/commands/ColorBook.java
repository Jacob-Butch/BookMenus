...
public class ColorBook implements CommandExecutor {

    public ColorBook() {
    }

    public static Text getDescription() {
        return Text.of("/colorbook");
    }

    public static String[] getAlias() { return new String[]{"colorbook"}; }
    ...
    public CommandResult execute(@Nonnull CommandSource src, @Nonnull CommandContext args) throws CommandException {
        ...
        if(player.getItemInHand(HandTypes.MAIN_HAND).isPresent()) {
            ...
            if(item.get(Keys.BOOK_PAGES).isPresent()) {
                ...
                player.sendMessage(TextSerializers.FORMATTING_CODE.deserialize("&6&oThe book in your hand has been colored."));
            } else {
